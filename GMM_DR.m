function [Priors2, Mu, Sigma, expData, Pix] = GMM_DR(Data, nbStates, numFrame)
%
...
% nbStates = 10;
threshold = 0.98;
nbPC = calPC(Data(2:end,:), threshold);
...
[Priors2, Mu2, Sigma2, Pix] = EM(Data2, Priors0, Mu0, Sigma0);
...
function [nbPC, percent, pc, latent] = calPC(input, threshold)
